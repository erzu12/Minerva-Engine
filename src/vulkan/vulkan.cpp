...
const std::string MODEL_PATH = "../../assets/models/sphere3.obj";
//const std::string MODEL_PATH = "models/test.obj";
const std::string TEXTURE_PATH = "../../assets/textures/planeDiff.png";
...
struct UniformBufferObject {
	...
	void Vulkan::initWindow() {
		...
		Vulkan::window = glfwCreateWindow(1400, 1000, "Vulkan", nullptr, nullptr);
